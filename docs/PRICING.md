...
| Price provenance | Every priced call is classified as **verified built-in**, **community feed**, **custom local**, or **provider/tool reported**. Custom prices override verified built-ins, which override the opt-in community feed. |
